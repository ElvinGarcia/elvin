...
export default function Codepen() {
  ...
  const pens = [{
    title: 'Analog Clock',
    snippet: <iframe height="300" width="100%;" scrolling="no" title="Analog Clock" src="https://codepen.io/elvingarcia/embed/RwGmjbB?default-tab=" frameborder="no" loading="lazy" allowtransparency={true} allowFullscreen={true}>
    See the Pen <a href="https://codepen.io/elvingarcia/pen/RwGmjbB">
  ...
  },
  {
    ...
    },
    {
      title: 'CSS ART',
    snippet:
    <iframe height="300" width= "100%" scrolling="no" title="A Simple CSS Art" src="https://codepen.io/elvingarcia/embed/abGmwBp?default-tab=" frameborder="no" loading="lazy" allowtransparency={true} allowFullscreen={true}>
    ...
    url:'https://codepen.io/elvingarcia/pen/abGmwBp',
    id: 'abGmwBp',
