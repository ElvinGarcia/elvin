...
class Content extends Component{
  ...
  render() {
    return (
      <>
      <h2> {this.props.assets.content.title} </h2>
      <div className='about_me'>
       <image src="/" alt="self portrait" className="self_portrait">{this.props.assets.images.svg}</image>
        <p className="content">{this.props.assets.content.content} </p>
